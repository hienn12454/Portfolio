...
public static class DependencyInjection
{
    ...
    {
        // Skip Npgsql registration in the Testing environment so that
        // WebApplicationFactory can supply its own InMemory provider without
        // triggering EF Core's "multiple database providers" error.
